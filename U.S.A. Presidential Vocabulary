...
# Print most_freq_words to the terminal
...
# Create a custom word embedding model based on your selection of presidents and analyze their language
# For example:
# custom_presidents_sentences = get_presidents_sentences(["president1", "president2"])
# custom_most_freq_words = most_frequent_words(custom_presidents_sentences)
# custom_embeddings = gensim.models.Word2Vec(custom_presidents_sentences, size=96, window=5, min_count=1, workers=2, sg=1)
# custom_similar_to_freedom = custom_embeddings.most_similar("freedom", topn=20)
# print(custom_most_freq_words)
# print(custom_similar_to_freedom)
